...
async function Profile(user_id) {
    ...
    document.getElementById('list-switch').innerHTML = `<a class="text_bold" href="profile.html?user_id=${user_id}">게시물</a> | <a href="#" class="text_normal" onclick="loadHeartArticles(${user_id})">좋아요</a>`;
